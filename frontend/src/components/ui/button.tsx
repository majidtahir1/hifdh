  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        ...
        gradient:
          "bg-gradient-to-r from-emerald-500 to-teal-600 text-white shadow-lg shadow-emerald-500/25 hover:shadow-xl hover:shadow-emerald-500/30 hover:from-emerald-400 hover:to-teal-500",
        "gradient-subtle":
          "bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-900 border border-emerald-200 hover:from-emerald-100 hover:to-teal-100",
        glass:
          "bg-white/80 backdrop-blur-sm border border-white/50 text-foreground shadow-sm hover:bg-white hover:shadow-md dark:bg-white/10 dark:border-white/20",
      },
      size: {
